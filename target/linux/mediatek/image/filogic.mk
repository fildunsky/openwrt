...
define Device/wwgate_ax3000-ubootmod
  DEVICE_VENDOR := wwGate
  DEVICE_MODEL := AX3000
  DEVICE_VARIANT := (OpenWrt U-Boot layout)
  DEVICE_DTS := mt7981b-wwgate-ax3000-ubootmod
  DEVICE_DTS_DIR := ../dts
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  ...
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := mt7981-bl2 spim-nand-ddr3
  ARTIFACT/bl31-uboot.fip := mt7981-bl31-uboot wwgate_ax3000
endef
TARGET_DEVICES += wwgate_ax3000-ubootmod
